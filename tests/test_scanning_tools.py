...
class TestScanningTools:
    ...
    def test_validate_host(self, valid_hosts, invalid_hosts):
        ...
        for host in valid_hosts:
            assert self.scanning_tools._validate_host(host) is True

        for host in invalid_hosts:
            assert self.scanning_tools._validate_host(host) is False
    ...
    def test_validate_ports(self, valid_ports, invalid_ports):
        ...
        for ports in valid_ports:
            assert self.scanning_tools._validate_ports(ports) is True

        for ports in invalid_ports:
            assert self.scanning_tools._validate_ports(ports) is False
